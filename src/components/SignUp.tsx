...
export function SignUp({ onNavigate, appConfig, monetization }: SignUpProps) {
  ...
  if (mode === 'forgot') {
    return (
      <div className="max-w-6xl mx-auto py-12 px-6 md:px-12 space-y-12">
        <AdSection placement="signup" layout="top" monetization={monetization} />
        ...
        <AdSection placement="signup" layout="bottom" monetization={monetization} />
      </div>
    );
  }
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center ml-1">
                <label htmlFor="password" title="password" className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">Senha</label>
                {mode === 'signup' && (
                  <button 
                    type="button"
            ...
            {mode === 'signup' && (
              <div className="space-y-2">
                <label htmlFor="confirm-password" title="confirm-password" className="text-xs font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest ml-1">Confirmar Senha</label>
                <div className="relative">
                  <LockIcon className="absolute left-4 top-1/2 -translate-y-1/2 text-slate-400" size={18} />
                  <input 
                    required
